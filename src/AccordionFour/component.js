...
export class AccordionFour extends Component {
  ...
  handleClickFinishE1 = (e) => {
    this.setState({
      notStarted: this.state.complete, svgNotStarted: this.state.svgComplete, svgNotChecked4: this.state.svgChecked,
      svgBadgeNotStarted1: this.state.svgBadgeComplete,
    });
  }

  handleClickFinishE2 = (e) => {
    this.setState({ notStarted2: this.state.complete, svgNotStarted2: this.state.svgComplete, svgNotCheckedE2C4: this.state.svgChecked, svgBadgeNotStarted2: this.state.svgBadgeComplete });
  }

  handleClickFinishE3 = (e) => {
    this.setState({ notStarted3: this.state.complete, svgNotStarted3: this.state.svgComplete, svgNotCheckedE3C3: this.state.svgChecked, svgBadgeNotStarted3: this.state.svgBadgeComplete });
  }
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 4 / Ep 1: What are DXC’s offerings?</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              ...
                              <a
                                ...
                                </span>Overview of 9 Offering families; how to learn more
</a>
                              ...
                              <a
                                ...
                                </span>Iterate until the customer buys</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m1-e3-list"
                                data-toggle="list"
                                ...
                                </span>The level of knowledge you need as a Seller - DXC's expectation</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m1-e4-list"
                                data-toggle="list"
                                ...
                                </span>Fully qualified deal: done and clear</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m1-e5-list"
                                data-toggle="list"
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 4 / Ep 2: How does DXC differentiate?</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              <a
                                ...
                                </span>What's the success stories/data & customer references?
</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e2-list"
                                ...
                                </span>Differentiation stories to use</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e3-list"
                                data-toggle="list"
                                ...
                                </span>Using the Business Value Framework tool to differentiate</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e4-list"
                                data-toggle="list"
                                ...
                                </span>How do I know who our current customers are using?</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e5-list"
                                data-toggle="list"
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 4 / Ep 3:  Customer conversations, part 4</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              <a
                                ...
                                </span>Mapping the customer outcome to DXC solutions/offerings</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m3-e2-list"
                                data-toggle="list"
                                ...
                                </span>Solutioning and buy in: using group meetings and 1:1s</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m3-e3-list"
                                data-toggle="list"
                                ...
                                </span>Examples/customer scenarios</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m3-e4-list"
                                data-toggle="list"
