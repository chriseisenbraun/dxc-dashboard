...
export class AccordionThree extends Component {
  ...
  handleClickFinishE2 = (e) => {
    this.setState({ notStarted2: this.state.complete, svgNotStarted2: this.state.svgComplete, svgNotCheckedE2C3: this.state.svgChecked, svgBadgeNotStarted2: this.state.svgBadgeComplete });
  }
  ...
  handleClickFinishE5 = (e) => {
    this.setState({ notStarted5: this.state.complete, svgNotStarted5: this.state.svgComplete, svgNotCheckedE5C3: this.state.svgChecked, svgBadgeNotStarted5: this.state.svgBadgeComplete });
  }
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 3 / Ep 1: Who are our partners?</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              ...
                              <a
                                ...
                                </span>Where do I find information on our partners?</a>
                              ...
                              <a
                                ...
                                </span>What is the relationship like between DXC and different partners?
</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m1-e3-list"
                                ...
                                </span>Finding out more about our partners - where to go</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m1-e4-list"
                                data-toggle="list"
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 3 / Ep 2: How do we manage partner relationships?</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              <a
                                ...
                                </span>Examples of healthy partner/DXC relationships
</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e2-list"
                                ...
                                </span>What do our partners expect from us?
</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e3-list"
                                ...
                                </span>What can we expect from our partners?
</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m2-e4-list"
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 3 / Ep 3: Who are our partners?</p>
                        <h3>Who are our partners?</h3>
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 3 / Ep 4: Co-pitching with partners</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              <a
                                ...
                                </span>Customer conversations with our partners - planning</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m4-e2-list"
                                data-toggle="list"
                                ...
                                </span>Executing a meeting with a partner - what does that look like?
</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m4-e3-list"
                                ...
                                </span>Expectations on who does what
</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m4-e4-list"
              ...
              <div
                ...
                <div className="card-body pt-0 pb-5">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm">
                        <p className="mission-breadcrumb">Mission 3 / Ep 5: Navigating multiple partner offers</p>
                          ...
                          <div class="col-sm col-md-4">
                            <div class="list-group" id="list-tab" role="tablist">
                              <a
                                ...
                                </span>Handling multiple “competing” partners</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m5-e2-list"
                                data-toggle="list"
                                ...
                                </span>Managing what is right for our clients and keeping a healthy partnership</a>
                              <a
                                class="list-group-item list-group-item-action"
                                id="list-m5-e3-list"
                                data-toggle="list"
                                ...
                                </span>Setting expectations with multiple partners</a>
                              {/* <a
                                class="list-group-item list-group-item-action"
                                id="list-m5-e4-list"
                                data-toggle="list"
